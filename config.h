...
//
    { MODKEY,              XK_F1,     spawn, SHCMD("killall nautilus || nautilus") },                             /* super F1         | 打开/关闭pcmanfm       */
    { MODKEY,              XK_d,      spawn, SHCMD("rofi -show run") },                                         /* super d          | rofi: 执行run          */
    { MODKEY,              XK_p,      spawn, SHCMD("~/scripts/rofi.sh") },                                       /* super p          | rofi: 执行自定义脚本   */
    { MODKEY,              XK_n,      spawn, SHCMD("~/scripts/blurlock.sh") },                                   /* super n          | 锁定屏幕               */
    ...
    TAGKEYS(XK_0, 6, "/usr/bin/mailspring")
